...
- (void)viewDidLoad {
	...
	NSString *OAuthURLString = [kGowallaOAuthURL stringByAppendingFormat:@"?redirect_uri=%@&client_id=%@&scope=%@", 
                                    kGowallaRedirectURI, 
                                    kGowallaAPIKey, 
                                    @"read-write"];
    
    NSURL *OAuthURL = [NSURL URLWithString:
                       [NSString stringWithFormat:@"https://gowalla.com/api/oauth/new?redirect_uri=%@&client_id=%@", 
                            kGowallaRedirectURI, 
                            kGowallaAPIKey
                        ]
                       ];
